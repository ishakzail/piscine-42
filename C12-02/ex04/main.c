...
int main()
{
	...
	ft_list_push_back(&begin, str_back);
	printf("Je rajoute un element a la fin et la liste a maintenant %d elements\n", ft_list_size(begin));
	printf("Le dernier elements contient %s\n", ft_list_last(begin)->data);
	return (0);
}
